...
#define BOARD_INITPINS_SD_CD_PORT 2U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_SD_CD_PIN 9U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_SD_CD_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                      /* @} */
...
#define BOARD_INITPINS_SD_CLK_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_SD_CLK_PIN 30U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_SD_CLK_PIN_MASK (1U << 30U)      /*!<@brief PORT pin mask */
                                                        /* @} */
...
#define BOARD_INITPINS_SD_CMD_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_SD_CMD_PIN 31U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_SD_CMD_PIN_MASK (1U << 31U)      /*!<@brief PORT pin mask */
                                                        /* @} */
...
#define BOARD_INITPINS_SD_DAT0_PORT 2U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_SD_DAT0_PIN 0U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_SD_DAT0_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                                        /* @} */
...
#define BOARD_INITPINS_SD_DAT1_PORT 2U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_SD_DAT1_PIN 1U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_SD_DAT1_PIN_MASK (1U << 1U)      /*!<@brief PORT pin mask */
                                                        /* @} */
...
#define BOARD_INITPINS_SD_DAT2_PORT 2U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_SD_DAT2_PIN 2U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_SD_DAT2_PIN_MASK (1U << 2U)      /*!<@brief PORT pin mask */
                                                        /* @} */
...
#define BOARD_INITPINS_SD_DAT3_PORT 2U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_SD_DAT3_PIN 3U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_SD_DAT3_PIN_MASK (1U << 3U)      /*!<@brief PORT pin mask */
                                                        /* @} */
