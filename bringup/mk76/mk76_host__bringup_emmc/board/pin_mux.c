...
- pin_list:
  ...
  - {pin_num: T12, peripheral: USDHC0, signal: 'USDHC_DATA, 3', pin_signal: PIO2_3/SD0_D3/SCT0_OUT1, pupdena: enabled, pupdsel: pullUp, ibena: enabled, slew_rate: normal,
    drive: normal, amena: disabled, odena: disabled, iiena: disabled}
  - {pin_num: T13, peripheral: GPIO, signal: 'PIO2, 4', pin_signal: PIO2_4/SD0_WR_PRT/SCT0_OUT2/SD0_DS, pupdena: disabled, pupdsel: pullDown, ibena: enabled, slew_rate: normal,
    drive: normal, amena: disabled, odena: disabled, iiena: disabled}
...
void BOARD_InitPins(void)
{
    ...
    IOPCTL_PinMuxSet(IOPCTL, BOARD_INITPINS_SD_CLK_PORT, BOARD_INITPINS_SD_CLK_PIN, SD_CLK);
    ...
    IOPCTL_PinMuxSet(IOPCTL, BOARD_INITPINS_SD_CMD_PORT, BOARD_INITPINS_SD_CMD_PIN, SD_CMD);
    ...
    IOPCTL_PinMuxSet(IOPCTL, BOARD_INITPINS_SD_DAT0_PORT, BOARD_INITPINS_SD_DAT0_PIN, SD_DAT0);
    ...
    IOPCTL_PinMuxSet(IOPCTL, BOARD_INITPINS_SD_DAT2_PORT, BOARD_INITPINS_SD_DAT2_PIN, SD_DAT2);
    ...
    IOPCTL_PinMuxSet(IOPCTL, BOARD_INITPINS_SD_DAT3_PORT, BOARD_INITPINS_SD_DAT3_PIN, SD_DAT3);
