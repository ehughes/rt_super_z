...
already supported, which can also be re-used on this RT_SUPER_B board.
...
.. zephyr-app-commands::
   ...
   :board: RT_SUPER_B/mimxrt685s/cm33
   :goals: flash
...
.. zephyr-app-commands::
   :zephyr-app: samples/hello_world
   :board: RT_SUPER_B/mimxrt685s/hifi4
   :goals: build
